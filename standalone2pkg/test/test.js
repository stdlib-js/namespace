...
var alias2standalone = require( './../../alias2standalone' );
...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof standalone2pkg, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns `null` if provided an unrecognized alias', function test( t ) {
	...
	for ( i = 0; i < values.length; i++ ) {
		t.strictEqual( standalone2pkg( values[ i ] ), null, 'returns expected value' );
	}
	t.end();
});
